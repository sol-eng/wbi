...
// WriteRepoConfigWorkbench writes the repo config to the Workbench config file
func WriteRepoConfigWorkbench(url string, source string) error {
	if source == "cran" {
...
// WriteSSLConfigWorkbench writes the SSL config to the Workbench config file
func WriteSSLConfigWorkbench(certPath string, keyPath string) error {
...
// WriteConnectURLConfigWorkbench writes the Connect URL config to the Workbench config file
func WriteConnectURLConfigWorkbench(url string) error {
	// check to ensure the line doesn't already exist
...
// WriteSAMLAuthConfigWorkbench writes the SAML auth config to the Workbench config file
func WriteSAMLAuthConfigWorkbench(idpUrl string) error {
	// check to ensure the lines don't already exist
	linesCheck := []string{
		"auth-saml=",
...
// WriteOIDCAuthConfigWorkbench writes the OIDC auth config to the Workbench config file
func WriteOIDCAuthConfigWorkbench(idpURL string, usernameClaim string, clientID string, clientSecret string) error {
...
// WritePAMAuthConfigWorkbench writes the PAM auth config to the Workbench config file
func WritePAMAuthConfigWorkbench() error {
	// TODO implement
	return nil
}

// WriteLDAPAuthConfigWorkbench writes the LDAP auth config to the Workbench config file
func WriteLDAPAuthConfigWorkbench() error {
	// TODO implement
	return nil
}
